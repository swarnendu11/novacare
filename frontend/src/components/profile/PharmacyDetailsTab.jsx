...
import { Building2, Clock, Pill, ShieldCheck } from "lucide-react";
import toast from "react-hot-toast";

export default function PharmacyDetailsTab() {
  const [editing, setEditing] = useState(false);
  const [form, setForm] = useState({
    pharmacyName: "NovaCare Central Pharmacy",
    licenseNumber: "PHR-DEL-2048",
    gstNumber: "07AAACN1234A1Z5",
    operatingHours: "24/7",
    inventoryLead: "Aarav Mehta",
    ...
    <div className="bg-white rounded-3xl p-6 sm:p-8 shadow-sm border border-slate-200">
      <div className="flex justify-between mb-8 pb-4 border-b border-slate-100">
        <h3 className="text-xl font-black flex items-center gap-2">
          <Pill className="w-5 h-5 text-blue-500" /> Pharmacy Details
        </h3>
        <button
